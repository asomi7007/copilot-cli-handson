...
green "============================================================"
echo "  Next steps:"
echo "  1) Go to your workspace (copy this line):"
echo "        cd \"$GAME_PATH\""
echo "  2) Register the shared gallery URL (BEFORE starting copilot):"
echo "        export LAB502_DASHBOARD_URL=\"$DASHBOARD_URL\""
echo "  3) Start Copilot:"
echo "        copilot"
echo "  4) In the chat, type  /login  to sign in to GitHub."
echo ""
green "  Then follow docs/00-intro onward. Have fun!"
echo  "  (Can't find the folder? Finder: Go -> Go to Folder -> $GAME_PATH)"
